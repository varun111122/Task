...
sealed class Resource {
    ...
    data class Failure(val isNetworkError: Boolean, val apiCode: String, val exception: ApiError) : Resource()
    ...
    data class Retry( val isNetworkError: Boolean, val apiCode: String, val exception: ApiError) : Resource()
